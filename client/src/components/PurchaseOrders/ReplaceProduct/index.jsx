...
const ReplaceProduct = (props) => {
  ...
  const { serverLink, shopDomain, moneyFormat } = useSelector(
    ...
    <>
      <table className="replaceTable">
        <tbody className="replaceTBody">
          ...
          <tr>
            <td style={{ border: "none" }} className="replaceTd">
              Price:
            </td>
            <th style={{ border: "none" }} className="replaceTh">
              {pCost}
            </th>
          </tr>
        </tbody>
      ...
      {props.replace ? (
        <div style={{ marginTop: "none" }}>
          ...
          >
            <Button
              onClick={() =>
                getAlternateProducts(InputValue, product.variantId)
              }
            >
              {Searching ? (
                <Spinner accessibilityLabel="Search product" size="small" />
              ) : (
                "Search"
              )}
            </Button>
